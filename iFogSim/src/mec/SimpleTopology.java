...
public class SimpleTopology {
	...
	private static FogDevice addDevices(String id, int userId, String appId, int parentId){
		...
		Sensor sensor = new Sensor("s-"+id, "TEMPERATURE", userId, appId, new DeterministicDistribution(5)); // inter-transmission time of camera (sensor) follows a deterministic distribution
		sensors.add(sensor);
		Actuator ptz = new Actuator("ptz-"+id, userId, appId, "PTZ_CONTROL");
		actuators.add(ptz);
		//sensor.setGatewayDeviceId(sensor.getId());
