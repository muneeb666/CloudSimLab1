...
import org.fogapp.imp.security.Deterministic;
...
public class SensorGui extends Node implements Serializable{
	...
	public SensorGui(String name, String sensorType, String selectedItem, double normalMean_,
		...
		if(normalMean_ != -1){
			...
			setDistribution(new Deterministic(deterministicVal_));
		}
	}
	...
	public String toString() {
		...
		else if(distribution instanceof Deterministic)
			return "Sensor [dist=3 value=" + ((Deterministic)distribution).getValue() + "]";
		else
			return "";
	}
