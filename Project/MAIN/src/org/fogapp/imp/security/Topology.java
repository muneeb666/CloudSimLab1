...
public class Topology extends JFrame {
            ...
            public void actionPerformed(ActionEvent event) {
            	if("i"==mode){
            		...
            		SDNRun run = new SDNRun(physicalTopologyFile, deploymentFile, 
            								workloads_background, workloads, Topology.this);
	...
	protected void openAddActuatorDialog() {
		AddActuator actuator = new AddActuator(physicalGraph, Topology.this);
		physicalCanvas.repaint();
	}
	
	protected void openAddLinkDialog() {
		AddLink phyEdge = new AddLink(physicalGraph, Topology.this);
    	physicalCanvas.repaint();
		
	}

	protected void openAddFogDeviceDialog() {
		AddFogDevice fogDevice = new AddFogDevice(physicalGraph, Topology.this);
    	physicalCanvas.repaint();
    ...
    private void openAddPhysicalNodeDialog(){
    	AddPhysicalNode phyNode = new AddPhysicalNode(physicalGraph, Topology.this);
    	physicalCanvas.repaint();
    }
    private void openAddPhysicalEdgeDialog(){
    	AddPhysicalEdge phyEdge = new AddPhysicalEdge(physicalGraph, Topology.this);
    	physicalCanvas.repaint();
    }

    protected void openAddSensorDialog() {
		AddSensor sensor = new AddSensor(physicalGraph, Topology.this);
		physicalCanvas.repaint();
	}
