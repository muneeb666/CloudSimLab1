...
public class Controller extends SimEntity{
	...
	public void startEntity() {
		for(String appId : applications.keySet()){
			if(getAppLaunchDelays().get(appId)==1)
	...
	private void printNetworkUsageDetails() {
		System.out.println("Total Network Usage in this System is = "+NetworkUsageMonitor.getNetworkUsage()/Config.MAX_SIMULATION_TIME);		
	}
	
	private void Service() {
		
		System.out.println("*********************************************");
		System.out.println("Services Managed :::");
		for(FogDevice fogDevice : getFogDevices()){
			System.out.println(fogDevice.getName() + " Total services managed are = "+fogDevice.getServices()/ fogDevice.probability);
		}
	}

	private FogDevice getCloud(){
		for(FogDevice dev : getFogDevices())
			if(dev.getName().startsWith("C")|| dev.getName().startsWith("E") || dev.getName().startsWith("L"))
			return dev;
		return null;
	}
	...
	private void printCostDetails(){
		...
		System.out.println("*********************************************");
		System.out.println("Cost for Execuation with delays = "+getCloud().getTotalCost());
		
		System.out.println("*********************************************");
	}
	
	private void printPowerDetails() {
		System.out.println("Energy consumed at Devices: ");
		for(FogDevice fogDevice : getFogDevices()){
			System.out.println(fogDevice.getName() + " : Energy Consumption in = "+fogDevice.getEnergyConsumption()/ fogDevice.value);
		}
	}
	...
	private void printTimeDetails() {
		...
		System.out.println("***************************************************");
		System.out.println("TUPLES AND CPU EXECUTION TIME IS : "+ (Calendar.getInstance().getTimeInMillis() - TimeKeeper.getInstance().getSimulationStartTime()));
		System.out.println("=========================================");
	    System.out.println("=========================================");
	System.out.println("Application delays:: ");
	...
	private void processAppSubmit(Application application){
		System.out.println(CloudSim.clock()+" The given application "+ application.getAppId() +" is being simulated");
		FogUtils.appIdToGeoCoverageMap.put(application.getAppId(), application.getGeoCoverage());
		getApplications().put(application.getAppId(), application);
